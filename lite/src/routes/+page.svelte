...
<main
  class="relative flex h-screen w-screen flex-col items-center justify-center bg-repeat px-5"
  style=""
>
  ...
  <div class="mt-10 text-center text-3xl">The last scheduling app you'll ever need at LHS.</div>
