...
export type Asset = "/apple-touch-icon-precomposed.png" | "/apple-touch-icon.png" | "/favicon-48x48.png" | "/favicon.ico" | "/favicon.png" | "/fonts/suse/bold.ttf" | "/fonts/suse/regular.ttf" | "/icons/icon-128x128.png" | "/icons/icon-144x144.png" | "/icons/icon-152x152.png" | "/icons/icon-192x192.png" | "/icons/icon-384x384.png" | "/icons/icon-512x512.png" | "/icons/icon-72x72.png" | "/icons/icon-96x96.png" | "/robots.txt" | "/screenshots/desktop.png" | "/screenshots/mobile.png" | "/site.webmanifest" | "/web-app-manifest-192x192.png" | "/web-app-manifest-512x512.png";