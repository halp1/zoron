<script lang="ts">
  ...
  import { ListSelect } from "@zoron/common/components";
...
<div
  class="mx-10 md:mx-auto mt-5 mb-10 flex flex-1 flex-col gap-2 border-l-4 border-slate-600 lg:max-w-[1024px]"
>
