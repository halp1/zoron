...
<main class="flex h-screen w-screen flex-col items-center justify-center">
  ...
  <div class="flex w-96 flex-col gap-2">
    ...
    <div class="mb-3 text-sm text-slate-400">
			<Fa icon={faInfoCircle} class="mr-2 float-left mt-[3px]"/> Your information is encrypted and stored securely on the server. We will never send your credentials to a 3rd party. You will always have the option to permanently delete your account and the data associated with it.
		</div>
    <button
